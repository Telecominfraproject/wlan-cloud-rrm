...
if [[ "$TEMPLATE_CONFIG" = 'true' && ! -f /openwifi/settings.json ]]; then
  ...
  UCENTRALCONFIG_UCENTRALSECPORT=${UCENTRALCONFIG_UCENTRALSECPORT:-"17001"} \
  UCENTRALCONFIG_PRIVATEENDPOINT=${UCENTRALCONFIG_PRIVATEENDPOINT:-"https://owrrm.wlan.local:17006"} \
