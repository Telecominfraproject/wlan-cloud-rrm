...
public class TestUtilsTest {
	...
	void testGetVhtOper() {
		...
		String vht_oper = TestUtils.get_vht_oper(channelWidth, channel1, channel2, vhtMcsForNss);
		...
		vht_oper = TestUtils.get_vht_oper(channelWidth, channel1, channel2, vhtMcsForNss);
	...
	void testGetHtOper() {
		...
		String ht_oper = TestUtils.get_ht_oper(primaryChannel, secondaryChannelOffset, staChannelWidth, rifsMode,
		...
		ht_oper = TestUtils.get_ht_oper(primaryChannel, secondaryChannelOffset, staChannelWidth, rifsMode, htProtection,
