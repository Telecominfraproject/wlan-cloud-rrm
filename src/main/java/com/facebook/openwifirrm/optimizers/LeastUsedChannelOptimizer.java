...
public class LeastUsedChannelOptimizer extends ChannelOptimizer {
	 ...
	 */
	protected List<WifiScanEntryWrapper> getScanRespsByBandwidth(
		String band,
		String serialNumber,
		int channelWidth,
		Map<String, List<WifiScanEntryWrapper>> deviceToWifiScans
		...
		List<WifiScanEntryWrapper> scanRespsProcessed = new ArrayList<WifiScanEntryWrapper>();
		...
		for (WifiScanEntryWrapper entry : scanResps) {
			...
			newEntry.entry.channel = primaryChannel;
	...
	public Map<String, Map<String, Integer>> computeChannelMap() {
		...
		for (String band : bandsMap.keySet()) {
			...
			Map<String, List<WifiScanEntryWrapper>> deviceToWifiScans = getDeviceToWiFiScans(
